...
let userModi = localStorage.getItem('userModi');
let idMod;
let userAmodi;
   ...
   // let usuario = "";
    ...
    if (usuario == "Empresa" || usuario == "") {
        ...
        if (error == true) {
            ...
            let respuesta = actualizarUsuario(idMod, userAmodi, pnombre, snombre, papellido, sapellido, selectTipoIDs,
    ...
    if (usuario == "Cliente" || usuario=="Administrador") {
        ...
        if (error == true) {
            ...
            let respuestac = actualizarUsuario(idMod, userAmodi, pnombre, snombre, papellido, sapellido, selectTipoIDs,
                identidad, feNac, edad, correo, sexo, razon, fantasia,
                selectTipoIDReps, identidadRep, correoRep, clave, imagen);
            //  mostrarClientes();
